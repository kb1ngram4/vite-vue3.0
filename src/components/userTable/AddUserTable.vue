<template>
  <div class="add_table">
    <el-dialog v-model="isDialog.value" :title="title" width="50%" @close="resetForm(ruleFormRef)" :rules="rules"
      align-top>
          ...
          <el-col :span="12">
            <el-form-item label="角色：" prop="role">
              <el-select :disabled="isDisable" placeholder="请选择角色" v-model="form.role">
                <el-option v-for="item, index in roleList" :key="index" :value="item.value"
...
<script lang="ts">
export default { name: 'AddUserTable' }
</script>
